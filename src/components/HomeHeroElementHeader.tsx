...
const HomeHeroElementHeader = ({ icon, label, id, handleClick }: Props) => {
  return (
    <div
      className="flex w-[6.5rem] cursor-pointer flex-col items-center justify-between gap-5 px-5 pb-6 pt-5 transition-colors duration-200 hover:text-greyActive"
